...
- [Spark Streaming Real Project Tutorial](https://github.com/lizhanmit/sparktrain)
  ...
  - [Integrate Spark Streaming and Spark SQL to process socket data and do word count.](https://github.com/lizhanmit/sparktrain#sparksqlnetworkwordcountscala)
  - [Integrate Spark Streaming and Flume to process socket data and do word count in push-based approach.](https://github.com/lizhanmit/sparktrain#flumepushwordcountscala)
    - [local mode](https://github.com/lizhanmit/sparktrain#local-mode)
    - [server mode](https://github.com/lizhanmit/sparktrain#server-mode-in-real-projects)
  - [Integrate Spark Streaming and Flume to process socket data and do word count in pull-based approach.](https://github.com/lizhanmit/sparktrain#flumepullwordcountscala)
    - [server mode](https://github.com/lizhanmit/sparktrain#server-mode-in-real-projects-1)
