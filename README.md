...
- [Generative AI](https://github.com/lizhanmit/learning-notes/blob/master/generative-ai-note/generative-ai-note.md)
- [Hadoop](https://github.com/lizhanmit/learning-notes/blob/master/hadoop-note/hadoop-note.md)
...
- [Kafka Streams](https://github.com/lizhanmit/learning-notes/blob/master/kafka-streams-note/kafka-streams-note.md)
...
- [Spark Streaming Real Project Tutorial](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis)
  - [Kafka client app (producer and consumer)](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#srcmainjavacomzhandevsparkkafka)
  - [Spark Streaming receives socket data and does word count.](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#networkwordcountscala)
  - [Spark Streaming processes file system (local/hdfs) data and does word count.](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#filewordcountscala)
  - [Spark Streaming processes socket data with state and does word count.](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#statefulwordcountscala)
  - [Spark Streaming processes socket data and save the wordcount result into MySQL.](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#foreachrddappscala)
  - [Use Spark Streaming to filter blacklist.](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#blacklistfilteringscala)
  - [Integrate Spark Streaming and Spark SQL to process socket data and do word count.](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#sparksqlnetworkwordcountscala)
  - [Integrate Spark Streaming and Flume to process socket data and do word count in push-based approach.](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#flumepushwordcountscala)
    - [local mode](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#local-mode)
    - [server mode](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#server-mode-in-real-projects)
  - [Integrate Spark Streaming and Flume to process socket data and do word count in pull-based approach.](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#flumepullwordcountscala)
    - [server mode](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#server-mode-in-real-projects-1)
  - [Integrate Spark Streaming and Kafka to do word count in direct approach.](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#kafkadirectwordcountscala)
    - [local mode](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#local-mode-1)
    - [server mode](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#server-mode-in-real-projects-2)
  - [Web Log Streaming Workflow](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#web-log-streaming-workflow)
  - [Spark Streaming Real Project](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#spark-streaming-real-project)
  - [Web Log Generator](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#web-log-generator)
  - [Web Log ==> Flume](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#web-log--flume)
  - [Web Log ==> Flume ==> Kafka](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#web-log--flume--kafka)
  - [Web Log ==> Flume ==> Kafka ==> Spark Streaming](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#web-log--flume--kafka--spark-streaming)
  - [Web Log ==> Flume ==> Kafka ==> Spark Streaming ==> Data Cleansing](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#web-log--flume--kafka--spark-streaming--data-cleansing)
  - [Do Statistics about Page View (PV)](https://github.com/lizhanmit/mooc-web-log-real-time-data-analysis#do-statistics-about-page-view-pv)
...
- [System Design Interview Preparation](https://github.com/lizhanmit/learning-notes/blob/master/interview-preparation/system-design-interview-preparation.md)
